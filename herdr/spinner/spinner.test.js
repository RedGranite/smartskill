...
(async () => {
  ...
  assert.deepEqual(writes.filter((params) => params.pane_id === "blocked").map((params) => params.tokens.spin_blocked), ["⚠️", "⚠️", "\u2800\u2800", "\u2800\u2800", "⚠️", "⚠️", "\u2800\u2800", "\u2800\u2800", "⚠️"]);
  ...
  console.log("PASS: slow ✅, ⚠️ blink, single status slot, ring frames, clear, fail-closed, interval validation, pipe protocol");
